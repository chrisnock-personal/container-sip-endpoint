...
- WAV file playback injected into the RTP stream
- Live audio relay to the browser
- On-demand call recording, with an auto-record option
- On-device Whisper transcription with speaker diarization — live during a call and post-call on demand, live transcription can be toggled off
